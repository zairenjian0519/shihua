...
typedef struct {
    ...
    char history_storage_backend[16];
    bool history_soe_enabled;
    char history_soe_table[64];
    int history_soe_max_records;
    bool history_yx_enabled;
    char history_yx_table[64];
    bool history_yc_enabled;
    char history_yc_table[64];
    bool history_dd_enabled;
    char history_dd_table[64];
